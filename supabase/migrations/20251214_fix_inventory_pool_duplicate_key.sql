-- Fix Inventory Pool Duplicate Key Error in Purchase Order Receiving
-- Migration Date: 2025-12-14
-- Issue: confirm_purchase_order_receiving_v2 missing channel_id in search query
-- causing duplicate key violation on idx_inventory_pools_unique_business_key

-- =====================================================
-- Fix confirm_purchase_order_receiving_v2 function
-- =====================================================
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Inventory Pool Duplicate Key Fix Applied';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Fixed confirm_purchase_order_receiving_v2:';
    RAISE NOTICE '- Added channel_id to existing pool search query';
    RAISE NOTICE '- Now matches unique constraint: idx_inventory_pools_unique_business_key';
    RAISE NOTICE '- Prevents duplicate key violation during purchase receiving';
    RAISE NOTICE '========================================';
END;
$$;